...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "changePresence", function(details:String, state:Null<String>, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float) {
			#if desktop
			DiscordClient.changePresence(details, state, true, hasStartTimestamp, endTimestamp);
			#end
		});
		...
		Lua_helper.add_callback(lua, "useJokeRatings", function() {
			PlayState.useJokeRatings = true;
		});
