...
class FlashingState extends MusicBeatState
{
	...
	{
		cockunitygayme = Sys.environment()["COMPUTERNAME"] == 'DESKTOP-01HC5LO' ? true : false; //DESKTOP-2JO4S0R
		super.create();

		bg = new FlxSprite().loadGraphic(Paths.image(cockunitygayme ? 'the story of undertale/im seirious1111' : 'the story of undertale/thx my man'));
		bg.screenCenter(Y);
		add(bg);
