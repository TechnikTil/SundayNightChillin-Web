...
class CharacterEditorState extends MusicBeatState
{
	...
	{
		healthBar.leftBar.color = healthBar.rightBar.color = FlxColor.fromRGB(healthIcon.healthFile.colors[0], healthIcon.healthFile.colors[1], healthIcon.healthFile.colors[2]);
